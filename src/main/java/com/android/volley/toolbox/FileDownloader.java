 ...
 * To start a new download request, invoke the {@link FileDownloader#add(String, String, com.android.volley.Listener)}
		...
		private boolean deploy() {
			...
			mRequest.setListener(new Listener<Void>() {
				...
				public void onProgressUpdate(long fileSize, long downloadedSize) {
					mListener.onProgressUpdate(fileSize, downloadedSize);
				}
			});

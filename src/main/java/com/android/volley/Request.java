...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    public Request(int method, String url, Listener<T> listener) {
        ...
        mHashParams = new HashMap<String, String>();
	...
	/**
	 * Set how long the cache is expired, {@link com.android.volley.cache.Cache}
	 ...
	 */
	public Request<T> setCacheExpireTime(TimeUnit timeUnit, int amount) {
	...
	/**
	 * Prepare to execute, invoke before {@link com.android.volley.stack.HttpStack#performRequest}.
	...
	public void deliverProgress(long totalSize, long transferred) {
		if (mListener != null) {
			mListener.onProgressUpdate(totalSize, transferred);
		}
	}
